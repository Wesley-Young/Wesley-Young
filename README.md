...
| [saltify](https://github.com/SaltifyDev/saltify)        | Kotlin   | Main Developer | 跨平台、可扩展的 QQ Bot 框架 | ⌨️ Developing  |
...
| Project                                                       | Language   | My Role        | Description                           | Status                     |
| ------------------------------------------------------------- | ---------- | -------------- | ------------------------------------- | -------------------------- |
| [Cecilia](https://github.com/Wesley-Young/Cecilia)            | Kotlin     | Main Developer | 基于 Acidify + Compose 的即时聊天软件 | 🔒 Archived                |
